 ...
 * @author Lenovo
 */
public class CalApp extends javax.swing.JFrame {
 ...
 int calculation;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalApp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
